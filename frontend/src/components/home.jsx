...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-200 via-gray-700 to-black">
      <Navbar />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8 lg:space-y-10">
              <div className="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur rounded-full text-sm font-medium text-slate-900 border border-white/30">
                <Award className="w-4 h-4 mr-2 text-slate-800" />
            ...
            <div className="relative">
              <div className="relative group">
                <div className="absolute -inset-4 bg-gradient-to-r from-slate-200/50 to-slate-300/50 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500"></div>
                <img 
                  src="/src/assets/hero.jpg" 
                  alt="AI Interview Simulation Dashboard" 
                  className="relative w-full h-80 sm:h-96 lg:h-[500px] object-cover rounded-2xl shadow-2xl border border-slate-200/50 group-hover:shadow-3xl transition-all duration-500"
                  onError={(e) => {
      ...
      <section id="features" className="py-16 lg:py-24 bg-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 lg:mb-20">
            ...
            <p className="text-gray-200 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-8 lg:gap-12">
              {[
              {
                ...
                description: "Tailored questions for your specific role and industry, from software engineering to product management with real-world scenarios."
              },
              {
                title: "Technical & Behavioral",
                description: "Practice both technical coding challenges and behavioral questions to ace every aspect of your interview with comprehensive coverage."
              },
              {
                title: "Real-Time Feedback",
                description: "Get instant, actionable feedback on your responses to improve your performance on the spot with AI-powered analysis."
              },
              {
                title: "Detailed Analytics",
                description: "Comprehensive reports with performance metrics, strengths, and areas for improvement with personalized recommendations."
              }
            ].map((feature, index) => (
              <div key={index} className="group bg-white/5 backdrop-blur border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 hover:border-white/20 transition-all duration-500 hover:shadow-2xl hover:shadow-black/20 hover:-translate-y-1">
                <div className="flex flex-col">
                  ...
                  <div className="p-6 lg:p-8">
                    <h3 className="font-bold text-xl lg:text-2xl text-white mb-4 relative group-hover:text-blue-200 transition-colors duration-300">
                      {feature.title}
            ...
            <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
              {[
                ...
                <div key={index} className="group">
                  <div className="text-center bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:from-white/10 hover:to-white/15 hover:border-white/20 transition-all duration-500 h-full flex flex-col hover:shadow-2xl hover:shadow-black/10 hover:-translate-y-1">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-2xl lg:text-3xl text-white mb-6 group-hover:text-blue-200 transition-colors duration-300">
                        {item.title}
                      </h3>
      ...
      <section id="testimonials" className="py-16 lg:py-24 bg-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 p-8 lg:p-12 shadow-2xl">
                <div className="transition-all duration-700 ease-in-out" style={{ transform: `translateX(-${currentTestimonial * 100}%)` }}>
                  <div className="flex">
                    {testimonials.map((testimonial, index) => (
                      <div key={index} className="w-full flex-shrink-0">
                        <div className="max-w-4xl mx-auto text-center">
                          ...
                          {/* Quote */}
                          <blockquote className="text-xl lg:text-2xl text-gray-200 leading-relaxed mb-8 italic font-medium">
                            "{testimonial.content}"
                          </blockquote>
                          ...
                          <div className="flex items-center justify-center space-x-4">
                            ...
                            <div className="text-left">
                              ...
                              <div className="text-gray-300 font-medium text-lg">{testimonial.role}</div>
      ...
      {/* Footer */}
      <footer id="contact" className="bg-transparent border-t border-white/20 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                />
                <span className="font-bold text-xl text-white">PrepTera</span>
              </div>
